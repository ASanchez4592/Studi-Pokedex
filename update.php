...
<head>
    ...
    <title>Pokédex Studi - Modifier un Pokémon</title>
</head>
...
<body>
    ...
    <main class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <input type="number" min=1 max=1000 name="number" value="<?= $pokemon->getNumber(); ?>" placeholder="Le numéro du Pokémon" id="number" class="form-control">
            ...
            <img class="my-3 w-25" src="<?= $imagesManager->get($pokemon->getId())->getPath(); ?>" alt="<?= $pokemon->getName(); ?>">
